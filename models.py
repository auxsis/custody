...
class CustodyEquipment(models.Model):
    ...
    serial = fields.Char('Número de serie', track_invisiblty='onchange')
    ...
    item_id = fields.Many2many('equipment.item',string='Artículo')
    item_ids = fields.One2many(comodel_name="equipment.item.line", inverse_name="equip", required=False,string='Artículo' )
